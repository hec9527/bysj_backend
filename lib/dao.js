...
module.exports = {
    ...
    getEnglishDaily(callback) {
        const sql = 'SELECT * FROM jinshan ORDER BY time DESC LIMIT 0,1;';
        myQuery(sql, callback);
    },
    ...
    getUserByCount(count, passwd, callback) {
        const sql = `SELECT * FROM user WHERE count='${count}' and passwd='${passwd}';`;
        console.log(sql);
        myQuery(sql, callback);
    },
    ...
    getUserExistsByCount(count, callback) {
        const sql = `SELECT * FROM user WHERE count='${count}';`;
        console.log(sql);
        myQuery(sql, callback);
    },
    ...
    addUserByCount(count, passwd, callback) {
        ...
        const sql = `INSERT INTO user (count,passwd,name) values('${count}', '${passwd}', '${name}');`;
        console.log(sql);
        myQuery(sql, callback);
    },
};
