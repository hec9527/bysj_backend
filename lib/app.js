...
app.use(async (ctx, next) => {
    ...
    // TODO 搞定添加请求头之后跨域请求被阻止
    ctx.set(
        'Access-Control-Allow-Headers',
        'Content-Type,X-Requested-With,X-Requested-With,Authorization,Accept,token'
    );
    ctx.set('Access-Control-Allow-Methods', 'POST,GET,OPTIONS,DELETE,HEAD,PUT,PATCH');
