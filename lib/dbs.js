...
items.user = {
  ...
  init: `create table if not exists ${config.table_user}(
    ...
    passwd char(32) not null, permission int(1) default 3, name varchar(20) not null unique, 
    avator varchar(256), age int(3), sex int(1), addr varchar(50), motto varchar(80),
    qq varchar(13), wechat varchar(20), email varchar(20), phone int(11), level int(3),
