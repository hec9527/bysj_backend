...
module.exports = {
     ...
     * @param {any} value
     */
    isEmty: function (value) {
        // if (this.typeof(value) === 'Function') {
        //     return true;
        // } else if (this.typeof(value) === 'Array' && value.length > 0) {
        //     return true;
        // } else if (this.typeof(value) === 'Object' && Object.keys(value).length > 0) {
        //     return true;
        // }else if(this.typeof(value) === un)
        if (value === undefined) {
            return true;
        } else if (value !== value) {
            return true;
            ...
            fs.readdir(dirPath, (error, files) => {
                if (error) {
                    ...
                    (files || []).forEach((fileName) => {
                        fileData.push(fs.readFileSync(path.join(dirPath, fileName), { encoding: 'utf-8' }));
                    });
                    return res(fileData);
                }
            });
